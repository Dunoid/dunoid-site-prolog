function check_form(form, tag:number): boolean { 
    ...
    var name: string,
        ...
        blockA: HTMLElement,
        blockN: HTMLElement,
        vName: boolean, //Flags for the values
        vAge: boolean;
...
function search_people(form, Id:number): boolean{
	var n: string, 
		a:string,
		blkA: HTMLElement,
		blkN: HTMLElement,
		results: HTMLElement,
		vForm: boolean =true; //Valid Form Flag
